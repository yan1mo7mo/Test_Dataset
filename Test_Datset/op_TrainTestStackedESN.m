function [prediction,test_error,n1] = op_TrainTestStackedESN(data,StackedESN,eLag,eDim,param2)
initLen = 0;
o_data=data;
n=length(data);
n1=param2;
...
for t=1:testLen-1 
     for i=1:eDim
         if i==1
             ...
             totalin= StackedESN{i}.Win*[1;StackedESN{i}.in]+...
                StackedESN{i}.Wres* StackedESN{i}.InternalState(:,max(trainLen+t-1));
         else
         ...
         x=(1-StackedESN{i}.a)*StackedESN{i}.InternalState(:,max(trainLen+t-1))+StackedESN{i}.a*tanh(totalin);
